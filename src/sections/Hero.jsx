...
//         <h1 className="mt-10 font-palanquin text-8xl max-sm:text-[72px] max-sm:leading-[82] font-light ">
//           <span className="xl:bg-white xl:whitespace-nowrap relative z-10 pr-10">The New Arrival</span>
//           <br />
//           <span className=" tex-coral-red inline-block mt-3 ">Nike </span>
//           Shoes
//         </h1>
...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className='relative xl:w-2/5 flex flex-col justify-center items-start mx-6  pt-28'>
